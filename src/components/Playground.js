...
const Playground = () => {
  const books = [
    ...
    { Name: "Don Quixote", Price: 10, Year: "1987", Available: false },

    { Name: "War and Peace", Price: 25, Year: "2009", Available: true },

    { Name: "The Great Gatsby", Price: 15, Year: "2005", Available: true },
  ];
